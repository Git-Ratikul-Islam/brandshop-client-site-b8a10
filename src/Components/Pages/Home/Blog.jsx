            ...
            <section className="bg-white dark:text-gray-100">
                  <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                        <a rel="noopener noreferrer" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-[#529fed]">
                              <img src="https://i.ibb.co/ZJ8dLWy/growtika-d-UMEn-ARXg-JU-unsplash.jpg" alt="" className="object-cover w-full h-64 rounded sm:h-96 lg:col-span-7 dark:bg-[#529fed]" />
                        ...
                        <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                              <a rel="noopener noreferrer" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-[#529fed]">
                                    <img role="presentation" className="object-cover w-full rounded h-44" src="https://i.ibb.co/m5xBJXc/pexels-shedrack-salami-16812192.jpg" />
                              ...
                              <a rel="noopener noreferrer" className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-[#529fed]">
                                    <img role="presentation" className="object-cover w-full rounded h-44 " src="https://i.ibb.co/s3C6rfK/carl-raw-m3hn2-Kn5-Bns-unsplash.jpg" />
                                    <div className="p-6 space-y-2">
                              ...
                              <a rel="noopener noreferrer" className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-[#529fed]">
                                    <img role="presentation" className="object-cover w-full rounded h-44 " src="https://i.ibb.co/brY6s1v/sebastiano-piazzi-Wbekvae-0-P4-unsplash.jpg" />
                                    <div className="p-6 space-y-2">
